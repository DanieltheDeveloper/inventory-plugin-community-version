# Inventory System Plugin — Unreal Engine 5.3

A production-ready, multiplayer-compatible inventory and equipment plugin for Unreal Engine 5.3, written in C++ with full Blueprint support.
